...
/**
 * LuxiaLogo - Componente oficial de branding vectorial de LUXIA® Agro
 * Basado en los vectores oficiales de identidad de marca (https://luxiaagro.com/)
 */
export function LuxiaLogo({ 
  height = 28, 
  variant = 'auto', // 'auto' | 'color' | 'white' | 'dark'
  showSubtitle = false, 
  subtitle = 'ENTERPRISE CRM',
  className = '',
  style = {}
}) {
  // En variante 'auto', usa 'currentColor' o la variable CSS de marca
  let fillColor = '#961f80';
  if (variant === 'white') {
    fillColor = '#ffffff';
  } else if (variant === 'dark') {
    fillColor = 'var(--apple-text-primary, #0f172a)';
  } else if (variant === 'color') {
    fillColor = '#961f80';
  } else {
    // auto: en light usa #961f80, o adaptable vía CSS
    fillColor = 'var(--luxia-brand, #961f80)';
  }

  // Dimensiones aspect ratio original: 297.6 x 116.2 (~2.56:1)
  const width = Math.round(height * (297.6 / 116.2));

  return (
    <div className={`d-inline-flex align-items-center gap-2 ${className}`} style={{ textDecoration: 'none', ...style }}>
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 297.6 116.2" 
        style={{ 
          height: `${height}px`, 
          width: `${width}px`, 
          display: 'block',
